package org.sinabro.commonness.config.auth.oauth;
...
import org.sinabro.commonness.config.auth.oauth.provider.GoogleUserInfo;
import org.sinabro.commonness.config.auth.oauth.provider.NaverUserInfo;
import org.sinabro.commonness.config.auth.oauth.provider.OAuth2UserInfo;
